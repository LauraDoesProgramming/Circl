...
| +        | c_add_circl_elems              | Adds the sum of operator2 to every element of operator 1. <br/>Was this intended? Or was this supposed to be elementwise addition? Definitely needs a refactor and possible bug fix |
| -        | c_sub_circl_elems              | Subtracts the sum of operator2 from every element of operator one. Same TODO: as `c_add_circl_elems`                                                                                |
| ×        | c_mul_circl_elems              | see above but with product of operator2                                                                                                                                             |
| ÷        | c_div_circl_elems              | see above but with product of operator2                                                                                                                                             |
| %        | c_mod_circl_elems              | see above i didnt even check this time. Will likely need a rewrite too                                                                                                              |
